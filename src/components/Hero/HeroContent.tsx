  ...
  return (
    <div data-anim="content" className={styles.content}>
      ...
      <h1 className={styles.headline}>
        <span data-anim="word">Built.</span>{" "}
        <span data-anim="word">To</span>{" "}
        <span data-anim="word" className={styles.blue}>last.</span>
      </h1>

      <p data-anim="sub" className={styles.sub}>
        Infraforma is the digital delivery partner for complex infrastructure
        projects. We embed pre-construction through handover and deliver a
        digital asset operations actually use.
      </p>
